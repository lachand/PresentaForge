...
const EDITOR_BOOTSTRAP_GROUPS = Object.freeze([
    ...
    [
        ...
        '../shared/slides/slides-canvas-connectors-runtime.js?v=3',
        ...
        '../shared/slides/slides-canvas-events-runtime.js?v=5',
    ...
    ['../shared/slides/editor-ai-settings.js?v=2'],
    ...
    ['../shared/slides/editor-ai-client.js?v=2'],
    ...
    ['../shared/slides/editor-props-panel.js?v=23'],
    ...
    ['../shared/slides/editor-preview.js?v=16'],
    ...
    ['../shared/slides/editor-export.js?v=24'],
    ...
    ['../shared/slides/editor-quick-insert.js?v=13'],
