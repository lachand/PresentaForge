...
function _checkerElementA11yIssues(el, slideBg) {
    ...
    if (['text', 'list', 'definition', 'callout-box', 'exercise-block', 'before-after', 'mistake-fix', 'rubric-block', 'code-example', 'terminal-session', 'quote', 'diagramme'].includes(type)) {
    ...
    if (['heading', 'text', 'list', 'definition', 'callout-box', 'exercise-block', 'before-after', 'mistake-fix', 'rubric-block', 'code-example', 'terminal-session', 'quote', 'card', 'diagramme'].includes(type)) {
