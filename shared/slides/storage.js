...
(function initOEIStorage(global) {
    ...
    const KEYS = Object.freeze({
        ...
        AI_CLAUDE_SETTINGS: `${PREFIX}-ai-claude-settings`,
        AI_PROVIDER: `${PREFIX}-ai-provider`,
    ...
    const LEGACY_KEYS = Object.freeze({
        ...
        [KEYS.AI_CLAUDE_SETTINGS]: 'oei-ai-claude-settings',
        [KEYS.AI_PROVIDER]: 'oei-ai-provider',
